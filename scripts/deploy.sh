...
sshpass -p $pwd scp cp -P 22 -o StrictHostKeyChecking=no violet-app/violet-app-admin/target/violet-app-admin-0.0.1-SNAPSHOT.jar root@$serverIp:/root/violet/app/admin
