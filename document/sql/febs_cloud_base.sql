...
-- ----------------------------
DROP TABLE IF EXISTS `rms_oauth_client_details`;
CREATE TABLE `rms_oauth_client_details`
(
...
-- ----------------------------
BEGIN;
INSERT INTO `rms_oauth_client_details`
...
-- ----------------------------
DROP TABLE IF EXISTS `rms_data_permission_test`;
...
-- ----------------------------
BEGIN;
INSERT INTO `rms_data_permission_test`
...
(
    ...
    `sort_index`  bigint(20) DEFAULT NULL COMMENT '排序',
...
-- ----------------------------
DROP TABLE IF EXISTS `rms_generator_config`;
CREATE TABLE `rms_generator_config`
(
...
-- ----------------------------
BEGIN;
INSERT INTO `rms_generator_config`
VALUES (1, 'guqing', 'xyz.guqing.violet.server.generator.gen', 'entity', 'mapper', 'mapper', 'service', 'service.impl',
        'controller', '1', 't_');
COMMIT;
...
-- ----------------------------
-- Table structure for rms_log
-- ----------------------------
DROP TABLE IF EXISTS `rms_log`;
CREATE TABLE `rms_log`
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    KEY `rms_log_create_time` (`CREATE_TIME`)
) ENGINE = MyISAM
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8
...
-- ----------------------------
-- Table structure for rms_logger
-- ----------------------------
DROP TABLE IF EXISTS `rms_logger`;
CREATE TABLE `rms_logger`
(
...
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    KEY `rms_login_log_login_time` (`LOGIN_TIME`)
) ENGINE = MyISAM
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8
...
(
    ...
    KEY `rms_menu_parent_id` (`parent_id`),
    KEY `rms_menu_menu_id` (`menu_id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 195
  DEFAULT CHARSET = utf8
...
(
    ...
    KEY `rms_role_menu_menu_id` (`menu_id`),
    KEY `rms_role_menu_role_id` (`role_id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
...
(
    ...
    KEY `rms_user_username` (`username`),
    KEY `rms_user_mobile` (`mobile`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
...
VALUES (1, 'guqing', '$2a$10$gzhiUb1ldc1Rf3lka4k/WOoFKKGPepHSzJxzcPSN5/65SzkMdc.SK', 2, '1484563614@qq.com', '17788888888',
        '1', '2019-06-14 20:39:22', '0', '1', 'white',
        'gaOngJwsRYRaVAuXXcmB.png', '我是帅比作者。',0, '2020-04-15 16:00:32', '2020-04-15 16:03:13');
INSERT INTO `rms_user`
VALUES (15, 'scott', '$2a$10$7tATi2STciLHnEgO/RfIxOYf2MQBu/SDVMRDs54rlSYVj2VmwwCHC', 5, 'scott@hotmail.com',
        '17720888888', '1', '2019-07-20 19:00:32', '2', NULL, NULL,
        'BiazfanxmamNRoxxVxka.png', NULL, 0, '2020-04-15 16:00:42', '2020-04-14 16:49:27');
INSERT INTO `rms_user`
VALUES (16, 'Jane', '$2a$10$ECkfipOPY7hORVdlSzIOX.8hnig0shAZQPG8pQ7D5iVP.uVogmmHy', 4, 'Jane@hotmail.com',
        '13489898989', '1', '2019-09-01 10:31:21', '1', NULL, NULL,
        '2dd7a2d09fa94bf8b5c52e5318868b4d9.jpg', NULL,0,'2020-04-15 16:00:48', '2019-09-01 10:32:27');
COMMIT;
-- ----------------------------
-- Table structure for rms_user_connection
-- ----------------------------
DROP TABLE IF EXISTS `rms_user_connection`;
CREATE TABLE `rms_user_connection`
(
...
-- ----------------------------
-- Records of rms_user_connection
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for rms_user_data_permission
-- ----------------------------
DROP TABLE IF EXISTS `rms_user_data_permission`;
CREATE TABLE `rms_user_data_permission`
(
...
-- ----------------------------
-- Records of rms_user_data_permission
-- ----------------------------
BEGIN;
INSERT INTO `rms_user_data_permission`
VALUES (1, 1);
INSERT INTO `rms_user_data_permission`
VALUES (1, 2);
INSERT INTO `rms_user_data_permission`
