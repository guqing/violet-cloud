...
INSERT INTO menu (id, parent_id, title, name, path, redirect, component, icon, keep_alive, hidden, perms, type, sort_index, create_time, modify_time) VALUES (13, 9, '用户组管理', 'UserGroup', '/ram/user/group', null, 'group/UserGroupList', null, 1, 0, 'group:view', '0', 13, '2020-06-05 18:35:27', '2020-06-05 18:35:31');
